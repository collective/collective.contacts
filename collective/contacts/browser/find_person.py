...
class FindPersonForm(PageForm):
    form_fields = form.FormFields(IPerson).omit('work_email2', 'work_email3', 'photo', 'organization')
    ...
    def __call__(self):
        ...
        self.form_fields['first_name'].field.required = False
        self.form_fields['last_name'].field.required = False
